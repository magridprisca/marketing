...
<!-- Process -->
                  <div class="form quick-post">
                    ...
                    <form class="form-horizontal" role="form" id="formInput" method="post" action="<?= base_url('C_Project/edit/'.$process->pro_code) ?>">
                      <!-- Project ID -->
                        ...
                        <table class="table table-advance table-bordered">
                          ...
                          <tbody>
                            ...
                            <tr style="background-color: #FFFFFF">
                              ...
                              <th><input type="checkbox" name="opsreq" <?php if($process->opsreq==1){echo "checked";} ?>></th>
                              <th><input type="date" name="tgl_opsreq" value="<?= date('Y-m-d')?>" border=0></th>
                            </tr>
                            <tr style="background-color: #FFFFFF">
                              <th>3</th>
                              <th colspan="2">Design</th>
                              <th><input type="checkbox" name="design" <?php if($process->design==1){echo "checked";} ?>></th>
                              <th><input type="date" name="tgl_design" value="<?= date('Y-m-d')?>" border=0></th>
                            </tr>
                            <tr style="background-color: #FFFFFF">
                              <th>4</th>
                              <th colspan="2">Presentasi</th>
                              <th><input type="checkbox" name="presentasi" <?php if($process->presentasi==1){echo "checked";} ?>></th>
                              <th><input type="date" name="tgl_presentasi" value="<?= date('Y-m-d')?>" border=0></th>
                            </tr>
                            <tr style="background-color: #FFFFFF">
                              <th>5</th>
                              <th colspan="2">Sourcing Harga</th>
                              <th><input type="checkbox" name="sourceprice" <?php if($process->sourcing_harga==1){echo "checked";} ?>></th>
                            ...
                            <tr style="background-color: #FFFFFF">
                              ...
                              <th><input type="checkbox" name="sff" <?php if($process->penyimpananDL==1){echo "checked";} ?>></th>
                          ...
                          <tbody>
                            ...
                            <tr style="background-color: #FFFFFF">
                              ...
                              <th><input type="checkbox" name="pgmL" <?php if($process->pengumumanL==1){echo "checked";} ?>></th>
                              <th><input type="date" name="tgl_pgmL" value="<?= date('Y-m-d')?>" border=0></th>
                            </tr>
                            <tr style="background-color: #FFFFFF">
                              <th>8</th>
                              <th colspan="2">Pendaftaran Lelang</th>
                              <th><input type="checkbox" name="pdfL" <?php if($process->pendaftaranL==1){echo "checked";} ?>></th>
                            ...
                            <tr style="background-color: #FFFFFF">
                              ...
                              <th><input type="checkbox" name="pmDP" <?php if($process->prakualifikasi1==1){echo "checked";} ?>></th>
                            ...
                            <tr style="background-color: #FFFFFF">
                              ...
                              <th><input type="checkbox" name="pmbDP" <?php if($process->prakualifikasi2==1){echo "checked";} ?>></th>
                            ...
                            <tr style="background-color: #FFFFFF">
                              ...
                              <th><input type="checkbox" name="pmbkDP"<?php if($process->prakualifikasi3==1){echo "checked";} ?>></th>
                            ...
                            <tr style="background-color: #FFFFFF">
                              ...
                              <th><input type="checkbox" name="hasilpraK"<?php if($process->prakualifikasi4==1){echo "checked";} ?>></th>
                              <th><input type="date" name="tgl_hasilpraK" value="<?= date('Y-m-d')?>" border=0></th>
                            </tr>
                            <tr style="background-color: #FFFFFF">
                              <th>13</th>
                              <th colspan="2">Pengambilan Dokumen Lelang</th>
                              <th><input type="checkbox" name="pgDL" <?php if($process->pengambilanDL==1){echo "checked";} ?>></th>
                              <th><input type="date" name="tgl_pgDL" value="<?= date('Y-m-d')?>" border=0></th>
                            </tr>
                            <tr style="background-color: #FFFFFF">
                              <th>14</th>
                              <th colspan="2">Aanwizjing</th>
                              <th><input type="checkbox" name="aanwizjing" <?php if($process->aanwizjing==1){echo "checked";} ?>></th>
                            ...
                            <tr style="background-color: #FFFFFF">
                              ...
                              <th><input type="checkbox" name="pmDPAT"<?php if($process->pemasukanD1==1){echo "checked";} ?>></th>
                            ...
                            <tr style="background-color: #FFFFFF">
                              ...
                              <th><input type="checkbox" name="pmbDPAT"<?php if($process->pemasukanD2==1){echo "checked";} ?>></th>
                            ...
                            <tr style="background-color: #FFFFFF">
                              ...
                              <th><input type="checkbox" name="evalAT" <?php if($process->pemasukanD3==1){echo "checked";} ?>></th>
                            ...
                            <tr style="background-color: #FFFFFF">
                              ...
                              <th><input type="checkbox" name="klarifAT" <?php if($process->pemasukanD4==1){echo "checked";} ?>></th>
                            ...
                            <tr style="background-color: #FFFFFF">
                              ...
                              <th><input type="checkbox" name="negoAT" <?php if($process->pemasukanD5==1){echo "checked";} ?>></th>
                            ...
                            <tr style="background-color: #FFFFFF">
                              ...
                              <th><input type="checkbox" name="pengumumanAT" <?php if($process->pemasukanD6==1){echo "checked";} ?>></th>
                            ...
                            <tr style="background-color: #FFFFFF">
                              ...
                              <th><input type="checkbox" name="pemasukanTwr" <?php if($process->pemasukanD7==1){echo "checked";} ?>></th>
                            ...
                            <tr style="background-color: #FFFFFF">
                              ...
                              <th><input type="checkbox" name="evalHarga" <?php if($process->pemasukanD8==1){echo "checked";} ?>></th>
                            ...
                            <tr style="background-color: #FFFFFF">
                              ...
                              <th><input type="checkbox" name="negoHarga" <?php if($process->pemasukanD9==1){echo "checked";} ?>></th>
                            ...
                            <tr style="background-color: #FFFFFF">
                              ...
                              <th><input type="checkbox" name="pengumumanMenang" <?php if($process->pemasukanD10==1){echo "checked";} ?>></th>
                              <th><input type="date" name="tgl_pengumumanMenang" value="<?= date('Y-m-d')?>" border=0></th>
                            </tr>
                            <tr style="background-color: #FFFFFF">
                              <th>25</th>
                              <th colspan="2">Tim Evaluasi Pengadaan (TEP)</th>
                              <th><input type="checkbox" name="TEP" <?php if($process->tep==1){echo "checked";} ?>></th>
                          ...
                          <tbody>
                            ...
                            <tr style="background-color: #FFFFFF">
                              ...
                              <th><input type="checkbox" name="SPMK" <?php if($process->spmk==1){echo "checked";} ?>></th>
                              <th><input type="date" name="tgl_SPMK" value="<?= date('Y-m-d')?>" border=0></th>
                            </tr>
                            <tr style="background-color: #FFFFFF">
                              <th>27</th>
                              <th colspan="2">Pembahasan Kontrak</th>
                              <th><input type="checkbox" name="bahasK" <?php if($process->pembahasanK==1){echo "checked";} ?>></th>
                              <th><input type="date" name="tgl_bahasK" value="<?= date('Y-m-d')?>" border=0></th>
                            </tr>
                            <tr style="background-color: #FFFFFF">
                              <th>27</th>
                              <th colspan="2">Penandatanganan Kontrak</th>
                              <th><input type="checkbox" name="ttdK" <?php if($process->penandatangananK==1){echo "checked";} ?>></th>
                              <th><input type="date"  name="tgl_ttdK" value="<?= date('Y-m-d')?>" border=0></th>
                            </tr>
                            <tr style="background-color: #FFFFFF">
                              <th>29</th>
                              <th colspan="2">Efektif Kontrak</th>
                              <th><input type="checkbox" name="efektifK" <?php if($process->efektifK==1){echo "checked";} ?>></th>
